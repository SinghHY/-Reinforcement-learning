...
# !pip install pytorch-lightning==1.9.5 pyvirtualdisplay
...
class OldGymAPIWrapper(gym.Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        return obs  # Old Gym only returned the observation

    def step(self, action):
        obs, reward, terminated, truncated, info = self.env.step(action)
        done = terminated or truncated  # Old Gym had a single `done`
...
class DeepQLearning(LightningModule):
  ...
  def training_epoch_end(self, training_step_outputs):
    ...
    self.log('episode/Return', self.env.env.return_queue[-1])
